...
export default function EditColor({ color }) {
    ...
    function SubmitHandler(e) {
        ...
        axiosAPIinstance.put(`color/update/${color._id}`, payload).then(
            (response) => {
    ...
    return (
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-10">
            ...
            {/* HEADER */}
            <div className="mb-6">
                <h1 className="text-3xl font-bold">Edit Color</h1>
                <p className="text-gray-500">
                    Edit a color with slug and code
                </p>
            </div>
            ...
            <form onSubmit={SubmitHandler} className="space-y-6">
                ...
                <div>
                    ...
                    <div className="p-4 font-medium">
                        <div className="w-10 h-10 rounded-md" style={{ background: color.code }}></div>
                    </div>
                </div>
